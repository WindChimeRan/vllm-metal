...
class KVCacheStorage:
    def __init__(self, config: KVCacheConfig):
        ...
        # Import the allocation once. All views then use the same MLX buffer,
        # so Metal's resource tracking also sees the aliases as one allocation.
        ...
        self.buffer = torch_to_mlx(raw.view(-1, page_bytes), copy=False)
